  ...
  return (
    <>
      ...
      <section className="relative top-12 lg:-top-22 z-0  ">
        <div className="absolute z-0 -top-[37rem] lg:top-0 bg-[url('/assets/images/ELLIPSE-simple.png')] bg-cover bg-center lg:bg-bottom h-[150vh] lg:h-[100vh] w-[100vw]">
        ...
        <div className=" relative py-10 px-4 lg:pt-50 lg:px-0 lg:pl-24 grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 z-10">
          ...
          <div className="bg-[url('/assets/images/location_image.png')] h-[calc(80vw-100px)] w-full lg:h-150 rounded-3xl lg:rounded-l-[50px] lg:rounded-r-none bg-cover lg:bg-cover lg:bg-center bg-no-repeat shadow-xl lg:shadow-none shadow-amber-50/20"></div>
        </div>
      </section>
    </>
  );
